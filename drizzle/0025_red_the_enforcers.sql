ALTER TABLE `group-habit-tracker_habits` MODIFY COLUMN `reminder_time` time DEFAULT '14:26:38';--> statement-breakpoint
CREATE TABLE `__new_group-habit-tracker_user_habits` (
	...
	`reminder_time` time DEFAULT '14:26:38',
	`joined_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`streak_count` bigint unsigned NOT NULL DEFAULT 0,
	`last_logged_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
