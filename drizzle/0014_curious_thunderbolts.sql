ALTER TABLE `group-habit-tracker_personalHabits` RENAME TO `group-habit-tracker_user_habits`;--> statement-breakpoint
ALTER TABLE `group-habit-tracker_user_habits` CHANGE `personalGoal` `goal`;--> statement-breakpoint
CREATE TABLE `__new_group-habit-tracker_user_habits` (
	`id` bigint unsigned AUTO_INCREMENT NOT NULL,
	`habitId` bigint unsigned NOT NULL,
...
INSERT INTO `__new_group-habit-tracker_user_habits`(`id`, `habitId`, `userId`, `goal`, `frequency`, `joinedAt`, `createdAt`, `updatedAt`) SELECT `id`, `habitId`, `userId`, `goal`, `frequency`, `joinedAt`, `createdAt`, `updatedAt` FROM `group-habit-tracker_user_habits`;--> statement-breakpoint
DROP TABLE `group-habit-tracker_user_habits`;--> statement-breakpoint
ALTER TABLE `__new_group-habit-tracker_user_habits` RENAME TO `group-habit-tracker_user_habits`;--> statement-breakpoint
